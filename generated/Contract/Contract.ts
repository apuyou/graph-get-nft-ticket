...
export class colleterizedMint extends ethereum.Event {
  get params(): colleterizedMint__Params {
    return new colleterizedMint__Params(this);
  }
}

export class colleterizedMint__Params {
  _event: colleterizedMint;

  constructor(event: colleterizedMint) {
    this._event = event;
  }
...
export class Contract__returnStructTicketResultValue0Struct extends ethereum.Tuple {
...
export class Contract__ticketMetadataAddressResult {
  value0: Address;
  value1: Array<Bytes>;
  value2: Array<BigInt>;
  value3: boolean;
...
export class Contract__ticketMetadataIndexResult {
  value0: Address;
  value1: Array<Bytes>;
  value2: Array<BigInt>;
  value3: boolean;
...
export class Contract extends ethereum.SmartContract {
  ...
  _mintGETNFT(
    ...
    let result = super.call(
      "_mintGETNFT",
      "_mintGETNFT(address,address,uint256,string,bytes32[],bool):(uint256)",
      [
  ...
  eventFinancingMint(
    ...
    let result = super.call(
      "eventFinancingMint",
      "eventFinancingMint(address,address,uint256,uint256,uint256,string,bytes32[]):(uint256)",
      [
        ethereum.Value.fromAddress(destinationAddress),
        ethereum.Value.fromAddress(eventAddress),
        ethereum.Value.fromUnsignedBigInt(strikeValue),
  ...
  isNFTClaimable(nftIndex: BigInt, ownerAddress: Address): boolean {
    let result = super.call(
      "isNFTClaimable",
      "isNFTClaimable(uint256,address):(bool)",
      [
  ...
  isNFTSellable(nftIndex: BigInt, ownerAddress: Address): boolean {
    let result = super.call(
      "isNFTSellable",
      "isNFTSellable(uint256,address):(bool)",
      [
        ethereum.Value.fromUnsignedBigInt(nftIndex),
        ethereum.Value.fromAddress(ownerAddress)
      ]
  ...
  returnStructTicket(
    nftIndex: BigInt
  ): Contract__returnStructTicketResultValue0Struct {
    let result = super.call(
      "returnStructTicket",
    ...
    return result[0].toTuple() as Contract__returnStructTicketResultValue0Struct;
  }

  try_returnStructTicket(
    nftIndex: BigInt
  ): ethereum.CallResult<Contract__returnStructTicketResultValue0Struct> {
    let result = super.tryCall(
      "returnStructTicket",
      "returnStructTicket(uint256):((address,bytes32[],uint256[],bool,bool,bool))",
      [ethereum.Value.fromUnsignedBigInt(nftIndex)]
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as Contract__returnStructTicketResultValue0Struct
    );
  }
  ...
  secondaryTransfer(
    ...
    let result = super.call(
      "secondaryTransfer",
      "secondaryTransfer(address,address,uint256,uint256):(uint256)",
      [
  ...
  ticketMetadataAddress(
    ownerAddress: Address
  ): Contract__ticketMetadataAddressResult {
    let result = super.call(
      "ticketMetadataAddress",
    ...
    return new Contract__ticketMetadataAddressResult(
      result[0].toAddress(),
  ...
  try_ticketMetadataAddress(
    ownerAddress: Address
  ): ethereum.CallResult<Contract__ticketMetadataAddressResult> {
    let result = super.tryCall(
      "ticketMetadataAddress",
      "ticketMetadataAddress(address):(address,bytes32[],uint256[],bool,bool,bool)",
      [ethereum.Value.fromAddress(ownerAddress)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__ticketMetadataAddressResult(
        value[0].toAddress(),
  ...
  ticketMetadataIndex(nftIndex: BigInt): Contract__ticketMetadataIndexResult {
    let result = super.call(
      "ticketMetadataIndex",
    ...
    return new Contract__ticketMetadataIndexResult(
      result[0].toAddress(),
      result[1].toBytesArray(),
      result[2].toBigIntArray(),
      result[3].toBoolean(),
  ...
  try_ticketMetadataIndex(
    nftIndex: BigInt
  ): ethereum.CallResult<Contract__ticketMetadataIndexResult> {
    let result = super.tryCall(
      "ticketMetadataIndex",
      "ticketMetadataIndex(uint256):(address,bytes32[],uint256[],bool,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(nftIndex)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__ticketMetadataIndexResult(
        value[0].toAddress(),
        value[1].toBytesArray(),
        value[2].toBigIntArray(),
        value[3].toBoolean(),
...
export class EventFinancingMintCall extends ethereum.Call {
  get inputs(): EventFinancingMintCall__Inputs {
    return new EventFinancingMintCall__Inputs(this);
  }

  get outputs(): EventFinancingMintCall__Outputs {
    return new EventFinancingMintCall__Outputs(this);
  }
}

export class EventFinancingMintCall__Inputs {
  _call: EventFinancingMintCall;

  constructor(call: EventFinancingMintCall) {
    this._call = call;
  }
...
export class EventFinancingMintCall__Outputs {
  _call: EventFinancingMintCall;
