...
export class EventContract__getEventDataResult {
  value0: Address;
  value1: Address;
  value2: string;
  value3: string;
...
export class EventContract__returnStructEventResultValue0Struct extends ethereum.Tuple {
...
export class EventContract extends ethereum.SmartContract {
  static bind(address: Address): EventContract {
    return new EventContract("EventContract", address);
  }
  ...
  getEventData(eventAddress: Address): EventContract__getEventDataResult {
    let result = super.call(
      "getEventData",
    ...
    return new EventContract__getEventDataResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_getEventData(
  ...
  ): ethereum.CallResult<EventContract__getEventDataResult> {
    let result = super.tryCall(
      "getEventData",
      "getEventData(address):(address,address,string,string,string,bytes32[4],uint256[2],bool,bytes32[],bool)",
      [ethereum.Value.fromAddress(eventAddress)]
    ...
    return ethereum.CallResult.fromValue(
      new EventContract__getEventDataResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toString(),
        value[3].toString(),
  ...
  getUnderwriterAddress(eventAddress: Address): Address {
    let result = super.call(
      "getUnderwriterAddress",
      "getUnderwriterAddress(address):(address)",
      [ethereum.Value.fromAddress(eventAddress)]
    );
  ...
  isInventoryUnderwritten(eventAddress: Address): boolean {
    let result = super.call(
      "isInventoryUnderwritten",
      "isInventoryUnderwritten(address):(bool)",
      [ethereum.Value.fromAddress(eventAddress)]
    );
  ...
  returnStructEvent(
    eventAddress: Address
  ): EventContract__returnStructEventResultValue0Struct {
    let result = super.call(
      "returnStructEvent",
    ...
    return result[0].toTuple() as EventContract__returnStructEventResultValue0Struct;
  }

  try_returnStructEvent(
    eventAddress: Address
  ): ethereum.CallResult<EventContract__returnStructEventResultValue0Struct> {
    let result = super.tryCall(
      "returnStructEvent",
      "returnStructEvent(address):((address,address,address,string,string,string,bytes32[4],uint256[2],bool,bytes32[],bool,bool))",
      [ethereum.Value.fromAddress(eventAddress)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as EventContract__returnStructEventResultValue0Struct
    );
  }
}
